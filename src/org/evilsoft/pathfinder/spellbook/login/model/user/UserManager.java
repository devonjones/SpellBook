package org.evilsoft.pathfinder.spellbook.login.model.user;

import org.evilsoft.pathfinder.spellbook.login.model.manager.BaseManager;
...
public class UserManager extends BaseManager {
	...
	public void authenticate(String username, String password) {
		...
		ParseUser
				.logInInBackground(username, password, new UserLogInCallback());
	}
	...
	/**
	 * Dispatches a forgot password request. The request will send an email to
	 * the address if an account for that address exists.
	 * 
	 * @param email
	 ...
	 */
	@Produce
	public UserForgotPasswordErrorEvent produceUserForgotPasswordErrorEvent(
			ParseException exception) {
	...
	private class UserSignUpCallback extends SignUpCallback {
		...
		public UserSignUpCallback(ParseUser user) {
			this.user = user;
		}
