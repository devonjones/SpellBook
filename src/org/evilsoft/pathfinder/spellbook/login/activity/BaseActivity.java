package org.evilsoft.pathfinder.spellbook.login.activity;
...
/**
 * Base activity class that handles the interaction of the Activity with the
 * service bus. Also includes an application wide implementation of the progress
 * dialog.
 * 
 * 
...
public class BaseActivity extends FragmentActivity {
	...
	protected void onPause() {
		/**
		 * activity must be removed from the service bus in onPause or an error
		 * will occur when the bus attempts to dispatch an event to the paused
		 * activity.
		 **/
